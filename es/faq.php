...
<html lang="es">
  <head>
    <meta charset="utf-8">
    <meta name="description" content="Having trouble? Check out our Frequently Asked Questions.">
    <meta name="keywords" content="IRentTLC, Rent, TLC, Luxary, Uber, Drive, Taxi">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
    <title>IRentTLC - FAQ</title>
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            ...
            <ul class="nav nav-tabs faq-cat-tabs">
                <li class="active"><a href="#faq-cat-1" data-toggle="tab">Categoría # 1</a></li>
                <li><a href="#faq-cat-2" data-toggle="tab">Categoría # 2</a></li>
            </ul>
    
            <!-- Tab panes -->
            <div class="tab-content faq-cat-content" style="
                        ...
                        <div class="panel panel-default panel-faq">
                            ...
                            <div id="faq-cat-1-sub-1" class="panel-collapse collapse">
                                <div class="panel-body">
									Respuesta a artículo en la Categoría # 1
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default panel-faq">
                    ...
                    <div class="panel-group" id="accordion-cat-2">
                        <div class="panel panel-default panel-faq">
                            ...
                            <div id="faq-cat-2-sub-1" class="panel-collapse collapse">
                                <div class="panel-body">
									Respuesta a artículo en la Categoría # 2
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default panel-faq">
        ...
        <div class="row text-center" id="suggestion">
        	<form method="post" action="">
        	<div class="col-md-8 col-md-offset-2">
        		<div class="col-md-12">
        			<div class="form-group">
        				<label style="color:white">¿Tiene alguna sugerencia?</label>
        			</div>
        		</div>
        		<div class="col-md-12">
        			<div class="form-group">
        				<textarea rows="5" class="form-control" name="comment" placeholder="Cuéntanos aquí!"></textarea>
        			</div>
        		</div>
				<div class="col-md-12">
        			<div class="form-group">
        				<button type="button" class="btn btn-default" id="submit">Entragar</button>
        			</div>
        		</div>
        	</form>
        	</div>
...
if(isset($_POST['submit'])){
    $query = "INSERT INTO `Suggestion` (`Comment`) VALUES ('".$comment."')";
