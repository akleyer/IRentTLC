                        ...
                        <div class="panel panel-default panel-faq">
                            ...
                            <div id="faq-cat-1-sub-1" class="panel-collapse collapse">
                                <div class="panel-body">
									Answer to FAQ Item in Category #1
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default panel-faq">
                    ...
                    <div class="panel-group" id="accordion-cat-2">
                        <div class="panel panel-default panel-faq">
                            ...
                            <div id="faq-cat-2-sub-1" class="panel-collapse collapse">
                                <div class="panel-body">
									Answer to FAQ Item in Category #2
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default panel-faq">
        	...
        	<div class="col-md-8 col-md-offset-2">
        		<div class="col-md-12">
        			<div class="form-group">
        				<label style="color:white">Have a suggestion?</label>
        			</div>
        		</div>
        		<div class="col-md-12">
        			<div class="form-group">
        				<textarea rows="5" class="form-control" name="comment" placeholder="Let us know here!"></textarea>
        			</div>
        		</div>
				<div class="col-md-12">
        			<div class="form-group">
